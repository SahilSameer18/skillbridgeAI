        ...
        <div className="landing-page animate-fade-in">
            ...
            <header className="hero animate-fade-in-up">
                <div className="hero-content">
                    <div className="hero-badge animate-scale-in">🤖 Powered by AI</div>
                    ...
                    <div className="cta-container">
                        {user ? (
                            <Link to="/generate" className="btn-primary highlight-glow">
                                ✨ Generate My Plan
                            </Link>
                        ) : (
                            <Link to="/register" className="btn-primary highlight-glow">
                                ✨ Get Started Free
                            </Link>
                        )}
            ...
            {/* ── Stats Bar ── */}
            <div className="stats-bar glass-morphism animate-fade-in">
                <div className="stats-bar__inner">
                    <div className="stat">
                        <span className="stat__number text-gradient">10K+</span>
                        <span className="stat__label">Plans Generated</span>
                    </div>
                    <div className="stat-divider" />
                    <div className="stat">
                        <span className="stat__number text-gradient">95%</span>
                        <span className="stat__label">Match Accuracy</span>
                    </div>
                    <div className="stat-divider" />
                    <div className="stat">
                        <span className="stat__number text-gradient">50+</span>
                        <span className="stat__label">Questions Generated</span>
                    </div>
                    <div className="stat-divider" />
                    <div className="stat">
                        <span className="stat__number text-gradient">7-Day</span>
            ...
            <section className="features-section">
                <div className="section-header animate-fade-in-up">
                    ...
                    <h2 className="text-gradient">Everything You Need to <span className="highlight">Ace the Interview</span></h2>
                </div>
                <div className="features-grid">
                    <div className="feature-card glass-morphism animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div className="feature-card glass-morphism animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                        <div className="feature-icon">🤖</div>
                    ...
                    <div className="feature-card glass-morphism animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                        <div className="feature-icon">📈</div>
                    ...
                    <div className="feature-card glass-morphism animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                    ...
                    <div className="feature-card glass-morphism animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                        <div className="feature-icon">📄</div>
                    ...
                    <div className="feature-card glass-morphism animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                        <div className="feature-icon">💾</div>
