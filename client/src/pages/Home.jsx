...
const features = [
  {
    icon: "🔍",
    title: "Deep Resume Profiling",
    desc: "AI extracts skills and maps them against target job requirements instantly.",
  },
  {
    icon: "🤖",
    title: "AI-Generated Questions",
    desc: "10+ tailored technical & behavioral questions with model answers specific to your role.",
  },
  {
    icon: "📈",
    title: "Skill Gap Analysis",
    desc: "See exactly which skills you're missing with severity ratings — High, Medium, Low.",
  },
  {
    icon: "🗺️",
    title: "10-Day Prep Roadmap",
    desc: "Day-by-day preparation tasks to close your skill gaps before the interview.",
  },
  {
    icon: "📄",
    title: "AI Resume Generator",
    desc: "Download a polished ATS-friendly PDF resume tailored to the job in under a minute.",
  },
  {
    icon: "💾",
    title: "Report History",
    desc: "All plans saved to your dashboard. Track multiple applications and revisit anytime.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    icon: "⚡",
    title: "AI Analyzes",
    desc: "AI parses your resume, compares it to the JD, and calculates a match score in ~30s.",
  },
  {
    num: "03",
    icon: "🎯",
    title: "Study Your Plan",
    desc: "Review tailored questions, skill gap tags, and follow the roadmap. Download your resume.",
  },
];
...
const personas = [
  {
    ...
    desc: "Crack your first tech role with targeted prep even without a polished resume.",
  ...
  },
  {
    ...
    desc: "Transition domains with a clear map of the gaps you need to close.",
  ...
  },
  {
    ...
    desc: "Prep for MAANG-level system design and behavioral rounds.",
  ...
  },
  {
    ...
    desc: "Align your profile with local market expectations and JD language.",
  ...
  return (
    <div className="animate-fade-in -mx-4 sm:-mx-6 lg:-mx-8">
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(6,182,212,0.12) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 60%, rgba(168,85,247,0.10) 0%, transparent 70%), #030712",
        }}
      >
        {/* Grid overlay */}
        <div
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              {/* Badge */}
              <div
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-medium mb-8 animate-scale-in"
                style={{
              ...
              <p className="text-base sm:text-lg text-slate-400 leading-relaxed mb-10 max-w-lg mx-auto lg:mx-0 animate-fade-in-up delay-100">
                Upload your resume + job description. Our AI builds a
                personalised question bank, identifies skill gaps, and gives you
                a 10-day prep roadmap — in under a minute.
              </p>
              ...
              >
                ...
                <div className="mb-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["System Design", "GraphQL", "Docker"].map((s, i) => (
                      <span
                        key={i}
                        className="text-xs px-2.5 py-1 rounded-lg font-medium text-red-400"
                        style={{
                    ...
                    {["TypeScript", "Redis"].map((s, i) => (
                      <span
                        key={i}
                        className="text-xs px-2.5 py-1 rounded-lg font-medium text-amber-400"
                        style={{
                ...
                >
                  ...
                  <p className="text-sm text-slate-300 leading-relaxed">
                    "Explain how you would architect a scalable real-time
                    notification system for 1M+ concurrent users..."
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center gap-1.5 mt-5">
                  {[0, 1, 2].map((i) => (
                    <div
                      ...
                      style={{
                        background: i === 1 ? "#06b6d4" : "rgba(71,85,105,0.6)",
                      }}
                    />
                  ))}
                </div>
      ...
      {/* ── STATS ── */}
      <div
        className="border-y border-slate-800/60 py-8 px-4"
      ...
      >
        <div className="max-w-5xl mx-auto flex flex-wrap justify-center gap-6 md:gap-0 md:grid md:grid-cols-4">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center gap-1 px-6 border-r border-slate-800/50 last:border-r-0"
            >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
              Everything to{" "}
              <span className="text-gradient-cyan">Ace the Interview</span>
            </h2>
            <p className="text-slate-400 text-lg max-w-xl mx-auto">
              A complete prep suite powered by advanced AI — from analysis to
              final PDF.
            </p>
          </div>
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 50%, rgba(168,85,247,0.05) 0%, transparent 70%)",
        }}
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
              Zero to{" "}
              <span className="text-gradient-cyan">Interview Ready</span> in 3
              Steps
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {steps.map((step, i) => (
              ...
              >
                <div
                  className="relative z-10 w-20 h-20 rounded-2xl flex flex-col items-center justify-center mb-5 shadow-xl"
                  style={{
                    background:
