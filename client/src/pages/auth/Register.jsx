...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030712] px-4 py-12"
      style={{ backgroundImage: 'radial-gradient(ellipse 80% 50% at 80% 0%, rgba(168,85,247,0.07) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 20% 10%, rgba(6,182,212,0.07) 0%, transparent 70%)' }}>
